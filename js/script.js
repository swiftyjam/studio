...
$(document).on('click', '.menu__button', function() {
 ...
 var up = "up";
var down = "down";
console.log("he clicasddddo");
if(r.hasClass(down)){
  r.removeClass(down);
  menu.css({'transform':'translate(0,-110vh)','opacity':'1'});
}else{
    menu.css({'transform':'translate(0,0vh)','opacity':'1'});
  r.addClass(down);
}
...
$( window ).resize(function() {
    ...
    $(".menu__options").css({'transform':'translate(0,0vh)','opacity':'1'});
    $(".rotate").addClass("down");
    }else{
    $(".rotate").removeClass("down");
    $(".menu__options").css({'transform':'translate(0,-110vh)','opacity':'1'});
    }
});
